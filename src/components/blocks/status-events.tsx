...
export function StatusEventTitleCheck({
  ...
  return (
    <div
      ...
      className={cn("flex items-center ps-1", className)}
      {...props}
    >
      <TooltipProvider>
        <Tooltip>
...
export function StatusEventAside({
  ...
  return (
    <div
      ...
      className="lg:-start-32 border border-transparent lg:absolute lg:top-0 lg:h-full"
    >
      <div className={cn("lg:sticky lg:top-0 lg:start-0", className)} {...props}>
        {children}
      </div>
    </div>
  );
